Ext.define('MyApp.view.org.orgtree.OrgTreeViewController', {
  extend: 'Ext.app.ViewController',
  alias: 'controller.orgtreeviewcontroller',
  ...
  onSelectionChange: function(selectable, selection) {
      ...
      if (selection.length) {
          ...
          if (selectedNode instanceof MyApp.model.tree.Territory) {
              ...
              button.enable();
          } else if (selectedNode instanceof MyApp.model.tree.Country) {
  ...
  addItem: function() {
      ...
      if (value) {
          ...
          } else if (target instanceof MyApp.model.tree.Territory) {
              // Programatically added - must not try to load over Ajax
              node.children = [];
              node.mtype = 'Country';
          } else if (target instanceof MyApp.model.tree.Country) {
